                                    ...
                                    <div class="product-footer">
                                        <div class="product-detail">
                                            ...
                                            <div class="add-to-cart-box bg-white">
                                                <a href="Product-Details?product_id=<?php echo $fetch_products[$i]['id'];?>" target="_blank" class="btn btn-add-cart addcart-button"><?php if($_SESSION['language'] === 'CN') echo '查看詳情'; else echo 'Detail';?>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
