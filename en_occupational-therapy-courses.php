                ...
                <div class="row g-4 ratio_65">
                    <div class="col-xxl-4 col-sm-6 ms-auto">
                        <div class="blog-box wow fadeInUp">
                            ...
                            <div class="blog-contain">
                                <a href="blog-detail.html">
                                    <h3>Healing Gel Exercise Basics 8 Sessions</h3>
                                    <p>
                                        With the theme of local snacks in Hong Kong, combined with therapeutic glue and other training tools, it trains finger strength, dexterity, hand-eye and hand coordination, etc., and improves writing and self-care skills. 【Kindergarten Group】
                                    </p>
                                </a>
                                <hr/>
                                ...
                                <button onclick="location.href = '1-Course';" class="blog-button">View courses<i class="fa-solid fa-right-long"></i></button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xxl-4 col-sm-6 me-auto">
                        <div class="blog-box wow fadeInUp" data-wow-delay="0.05s">
                            ...
                            <div class="blog-contain">
                                <a href="blog-detail.html">
                                    <h3>Therapy Gel Exercise 3 Sessions</h3>
                                    <p>
                                        There are cute little animals/insects as the theme, learn the basic method of using therapeutic glue in a fun way, and train small muscles [kindergarten group]
                                    </p>
                                </a>
                                <hr/>
                                <div class="blog-label">
                                    ...
                                    <span class="super"><span>Low-income families $150</span></span>
                                </div>
                                <button onclick="location.href = '2-Course';" class="blog-button">View courses<i class="fa-solid fa-right-long"></i></button>
                            </div>
                        </div>
                    </div>
