                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                ...
                                <div class="accordion-body">
                                    ...
                                    <p>（ii）網店消費密密賺- 於網店自行下單購物/參與任何課程，每消費$1，即可賺取1分。
                                        積分會以向下取整的方式計算至個位數，例如優惠後購物淨額為港幣99.5元，顧客便可穫得99分會員積分。
                                    </p>
                                    <p>
                                        （iii） 評價回贈---- 撰寫Carousell/Facebook好評，或直接提供試玩照片/建議，經店員確認後可獲得額外200積分。
                                    </p>
                                    <p>* 消費金額不包括運費及其他服務費用。</p>
                                    <p>* 會員積分只在會員登入後付款才可獲贈，如果顧客選用訪客形式結帳，將不能獲得積分，積分恕不補發。</p>
