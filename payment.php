        ...
        $messege = "
            <html>
                ...
                <div style='min-width: 200px; background-color: #ffffff; padding: 20px; margin: auto;'>
                    ...
                    <p style='color:black;'>
                    Your order is successfully placed. We will inform you about the delivery status soon. Please download the copy of your receipt from: <a href = 'https://wayshk.ngt.hk/print_receipt.php?id=$id' target='_blank'>Here</a>
                    </p>
                </div>
                </body>
            </html>";
