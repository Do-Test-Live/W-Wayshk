...
if (isset($_POST["placeOrder"])) {
    ...
    if ($payment != 'Credit Card') {
        ...
        $message = $img . '<br><br> Wayshk 活籽兒童用品店 - 訂單編號 WHK #' . $id .' <br><br>點擊以下連結檢視您的訂單詳情：' . $button . '<br><br> Order Details ' . $tableHtml . '<br><br>' . $payment1 . '<br><br><br><br>' . $payment2 . '<br><br>' . $footer;
