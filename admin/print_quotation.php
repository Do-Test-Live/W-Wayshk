...
$id = $_GET['id'];
$billing_details = $db_handle->runQuery("SELECT * FROM `quotation_details` WHERE id = '$id'");
?>
        ...
        <div class="cs-invoice_in" id="download_section">
            <div class="cs-invoice_head cs-type1 cs-mb25">
                <div class="cs-invoice_left">
                    ...
                    <p class="cs-invoice_number cs-primary_color cs-mb5 cs-f16"><b class="cs-primary_color">報價單 / Quotation</p>
                    <p class="cs-invoice_number cs-primary_color cs-mb5 cs-f16"><b class="cs-primary_color">報價編號：</b> #WHK<?php echo $billing_details[0]['id']; ?></p>
                ...
                <div class="cs-round_border">
                    <div class="cs-table_responsive">
                        <table>
                            ...
                            <tbody>
                            <?php
                            $invoice = $db_handle->runQuery("SELECT * FROM `quatation_products`,`product` WHERE billing_id = '$id' and quatation_products.product_id = product.id");
                            $no_invoice = $db_handle->numRows("SELECT * FROM `quatation_products`,`product` WHERE billing_id = '$id' and quatation_products.product_id = product.id");
