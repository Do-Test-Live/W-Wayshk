                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example3" class="display min-w850">
                                ...
                                <tbody>
                                <?php
                                $bill_data = $db_handle->runQuery("SELECT * FROM quotation_details where approve != '1' order by id desc");
                                $row_count = $db_handle->numRows("SELECT * FROM quotation_details where approve != '1' order by id desc");
