var Sego = function () {
    ...
    return {
        init: function () {
            ...
            }), c = window.outerHeight, ((c = window.outerHeight) > 0 ? c : screen.height) && $(".content-body").css("min-height", 1100 + "px"), $('a[data-action="collapse"]').on("click", function (e) {
