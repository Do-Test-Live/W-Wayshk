        ...
        <div class="row">
            <div class="col-12">
                <div class="about-us-title text-center">
                    <h2 class="center">訂購方法及條款細則</h2>
                </div>
                <h3 class="text-center mb-4" style="font-weight: bold">投下訂單</h3>
                ...
                <h3 class="text-center mt-5 mb-4" style="font-weight: bold">付款</h3>
                ...
                <h3 class="text-center mt-5 mb-4" style="font-weight: bold">出貨</h3>
                <div class="slider-3_1 product-wrapper mt-5">
                    <div>
                        <div class="clint-contain">
                            <div class="client-icon">
                ...
                <h3 class="text-center mt-5 mb-4" style="font-weight: bold">​自取點</h3>
                <div class="slider-3_1 product-wrapper mt-5">
                    <div>
                        <div class="clint-contain">
                            <div class="client-icon">
