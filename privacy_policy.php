        ...
        <div class="row">
            <div class="col-12">
                ...
                <ul>
                    ...
                    <li>本網站在您使用購物車、服務信箱等功能時，會保留您所提供的姓名、電子郵件地址、聯絡方式及使用時間等。
                    </li>

                    <li>
                        本網站將用你提供的個人資料，向你提供所需要的產品、活動、課程或服務，包括參與活動、課程或服務的相關用途、簽發收據、收集意見及資料分析。同時亦會使用你的個人資料向你提供有關活籽兒童用品店及有關單位的相關活動、課程、服務等推廣資訊。閣下有責任提供申請表格上列為「必填」的資料，或啟動相關流程必須提供的資料，否則本公司有可能無法提供閣下要求之服務。
                    </li>
                    <li>於一般瀏覽時，伺服器會自行記錄相關行徑，包括您使用連線設備的IP位址、使用時間、使用的瀏覽器、瀏覽及點選資料記錄等，做為我們增進網站服務的參考依據，此記錄為內部應用，決不對外公佈。
                    </li>
                    <li>您可以隨時向我們提出請求，以更正或刪除您的帳戶或本網站所蒐集的個人資料等隱私資訊。聯繫方式請見最下方聯繫管道。
                    </li>
                ...
                <ul>
                    ...
                    <li>如因業務需要有必要委託其他單位提供服務時，本網站亦會嚴格要求其遵守保密義務，並且採取必要檢查程序以確定其將確實遵守。
                    </li>
                </ul>
                ...
                <ul>
                    <li>對於本站之隱私權政策有任何疑問，或者想提出變更、移除個人資料之請求，請前往本站「聯絡我們」頁面提交表單。</li>
                    <li>或者 Email 至：ways00.hk@gmail.com</li>
